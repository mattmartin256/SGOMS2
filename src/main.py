...
class UnitTask:
    ...
    def printUnitTaskContents(self):
        '''Prints the unit task's ID, firing conditions, and behaviour'''
...
class UnitTaskSimpleDialogPanel(JPanel):
    ...
    def __init__(self, theUnitTask):
        ...
        aUnitTask should be a UnitTask - The text entries can '''
...
class UnitTaskDialog(JDialog):
    ...
    def __init__(self, theOwner = None, theTitle = "Create New Unit Task", isModal = True, theUnitTask = None):
        ...
        ## The UnitTaskPanel
        self.unitTaskPanel = UnitTaskDialogPanel(self.unitTask)
    ...
    def okButtonPressed(self, event):
        ...
        ## Right now these are hard-coded assuming there is only one firing condition and behaviour line, this should be changed later
...
class ButtonPanel(JPanel):
    ...
    def createNewUnitTask(self, event):
        ...
        dialog = UnitTaskDialog(self.frame, "Create New Unit Task", True, theUnitTask) ## theOwner, theTitle, isModal, theUnitTask
